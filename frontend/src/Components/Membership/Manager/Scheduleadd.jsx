...
const ScheduleAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const schedule = { Date: selectedDate, TimeSlot, Section };
                ...
                <form method="POST" className="add-promo" onSubmit={handleSubmit}>
                    <div className="flex items-center mb-12">
                        ...
                        <input
                            ...
                            min={new Date().toISOString().split('T')[0]} // Setting the min attribute to today's date
                            className="w-3/4 px-3 py-2 border-2 border-blue-400 rounded-xl"
                            required
                        />
                    </div>
                    <div className="flex items-center mb-12">
                        <label htmlFor="TimeSlot" className="w-1/4 py-2 mb-0 mr-4 font-medium text-white">Time Slot :</label>
                        <select
                            name="TimeSlot"
                            id="TimeSlot"
                            className="w-3/4 px-3 py-2 border-2 border-blue-400 rounded-xl"
                    ...
                    <div className="flex items-center mb-12">
                        <label htmlFor="Section" className="w-1/4 py-2 mb-0 mr-4 font-medium text-white">Section:</label>
                        <select
                            name="Section"
                            id="Section"
                            className="w-3/4 px-3 py-2 border-2 border-blue-400 rounded-xl"
