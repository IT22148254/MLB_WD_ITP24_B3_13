...
//         try {
//             const standardPackage = { Name, Price, Description, Duration };
//             const response = await axios.post('http://localhost:8070/package/package/add', standardPackage);
...
//                 Swal.fire({
//                     title: "Success",
//                     text: "New standard package added successfully",
//                     icon: "success",
//                 }).then(() => {
//                     console.log('New standard package added', response.data);
//                 });
//                 navigate('/pkg/standardetails');
//             }
//         } catch (error) {
//             console.error('Error adding standard package', error);
//             Swal.fire({
//                 title: "Error",
//                 text: "Failed to add new standard package",
//                 icon: "error"
//             });
//         }
//     };
